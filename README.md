...
| `useSessionExpiryInterval`           | Flag to enable/disable session expiry interval)                                                                                                               | Boolean     | `false`                         |
| `sessionExpiryInterval`           | Keep Session State (In seconds)                                                                                                               | Long     | `30`                         |
| `useSessionExpiryIntervalForDisconnect`           | Flag to enable/disable session expiry interval for disconnection)                                                                                                               | Boolean     | `true`                         |
