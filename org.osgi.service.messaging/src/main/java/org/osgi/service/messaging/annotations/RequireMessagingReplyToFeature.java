...
/**
 * This annotation can be used to require the Messaging Reply-To implementation. It
...
@Retention(CLASS)
@Target({ TYPE, PACKAGE })
@Requirement(namespace = IMPLEMENTATION_NAMESPACE, name = REPLY_TO_IMPLEMENTATION, version = MESSAGING_SPECIFICATION_VERSION)
public @interface RequireMessagingReplyToFeature {
