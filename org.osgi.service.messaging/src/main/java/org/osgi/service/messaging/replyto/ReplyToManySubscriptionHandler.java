...
public interface ReplyToManySubscriptionHandler {
    ...
    /**
     * Creates {@link PushStream} of response {@link Message}s for an incoming request {@link Message}. The response
     * builder is pre-configured. Properties like the channel and correlation are already set correctly to the
     * builder.
     *
