 ...
 *
 * Messaging provider implementations use this interface to provide logic to acknowledge a message using their
 * underlying protocol.
 *
...
public interface AcknowledgeHandler {
    ...
    /**
     * Acknowledge the message. The return values reflects, if the action was successful or not.
     *
    ...
    /**
     * Reject the message. The return values reflects, if the action was successful or not.
     *
