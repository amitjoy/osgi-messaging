...
public interface ReplyToSingleSubscriptionHandler {
	...
	/**
	 * Creates a {@link Promise} for response {@link Message} for the incoming
	 * request {@link Message}.
	 *
	 * The promise will be resolved, as soon a the execution completed successfully.
	 *
	 * Errors during the handling are delegated using the promise fail, behavior The
	 * response message context builder is pre-configured.
	 *
	 * Properties like the channel and correlation are already set correctly to the
	 * builder.
	 *
