...
/**
 * Context object that can be used to provide additional properties that can be
 * put to the underlying driver / connection.
 *
...
public interface MessageContext {
	...
	/**
	 * Returns the options map for additional configurations. The returning map can
