...
/**
 * This annotation can be used to require the Messaging implementation. It can
...
@Retention(CLASS)
@Target({ TYPE, PACKAGE })
@Requirement(namespace = IMPLEMENTATION_NAMESPACE, name = MESSAGING_IMPLEMENTATION, version = MESSAGING_SPECIFICATION_VERSION)
public @interface RequireMessagingFeature {
